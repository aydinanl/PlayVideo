	...
	<div id="main">
		...
		<div class="icerik_ust">
			<div class="container">
				<!-- icerik üst sol -->
				<div class="ustleft">	
					<div class="kolonbaslik"><h4><?php echo ucfirst($kategoriAdi) ?> <text>KATEGORİSİ</text></h4></div>
					<ul class="konuicerik">
                        <?php
                        while ($video_info = $getCategoryVideos->fetchObject()){
                            ?>
                            <li>
                            <a href="<?php echo URL ."Video/" . $video_info->movie_id ."/". $video_info->sef_link ?>">
                                    ...
                                    <div class="videobilgi"><label><i class="fa fa-eye"></i> <?php echo $video_info->movie_view ?></label><label><i class="fa fa-comment"></i> 451</label><label><i class="fa fa-bars"></i> <?php echo $video_info->category_name ?></label></div>
